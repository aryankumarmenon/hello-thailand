...
| Area                | Finding                                                                                                                                                                                                             | Source                                                                                                                        |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Vercel Hobby        | Non-commercial only; affiliate links and ads count as commercial. Pro $20/seat/month. 5,000 image transformations. No team collaboration features, so a second person cannot join the project (checked 16 Sep 2026) | [Fair use](https://vercel.com/docs/limits/fair-use-guidelines), [Hobby](https://vercel.com/docs/plans/hobby)                  |
